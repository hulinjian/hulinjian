...
public class Test {
	...
	static String ORIGINAL_TEST_PATH="D:"+File.separator+"JavaFile"+File.separator+"study"+File.separator+"original_text.txt";
	static String KEYHOLE_REPORT_PATH="D:"+File.separator+"JavaFile"+File.separator+"study"+File.separator+"keyhole_report.txt";
	...
	public static void main(String[] args) throws Exception {
		...
		huffmantree.CodeToString(root, readfile.readfile(KEYHOLE_REPORT_PATH));
